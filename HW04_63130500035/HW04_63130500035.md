...
จากโจทย์ได้ใช้ command ดังต่อไปนี้  <br>
`filter()` --> ระบุเงื่อนไขไว้ว่า หา <i>Type</i> ที่มีชื่อว่า "ebook"    <br>
`select()` --> เลือกใช้ variable ที่มีชื่อว่า <i>Book_title</i>, <i>Type</i> และ <i>Reviews</i>  <br>
...
จากโจทย์ได้ใช้ command ดังต่อไปนี้  <br>
`rename()` --> ระบุเงื่อนไขไว้ว่า หา <i>Rating</i> ที่มีมากที่สุด    <br>
ได้ใจความว่า หารายละเอียดทั้งหมดของหนังสือที่มี rating มากที่สุุด  
