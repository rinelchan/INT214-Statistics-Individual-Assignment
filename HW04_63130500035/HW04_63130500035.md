...
**
แยกกลุ่มโดยใช้สี type
แยกบรรทัดในแต่ละแปลงตามเพศ type
แยกเพิ่มเติมตามtypeโดยใช้color
น้ำหนักเฉลี่ยของแต่ละสายพันธุ์เปลี่ยนแปลงไปอย่างไร

Rating ของหนังสือแต่ละประเภทมีความสัมพันธ์กับราคาของหนังสืออย่างไร
สรุปได้ว่า ไม่มีความตายตัว 
หนังสือที่มีราคาถูกกว่าก็สามารถมี Rating สูงกว่า หนังสือที่มีราคาแพงกว่าได้
และ หนังสือที่มีราคาถูกกว่าก็สามารถมี Rating ต่ำกว่า หนังสือที่มีราคาแพงกว่าได้
หนังสือที่ราคาพอ ๆ กันก็มี Rating ที่ต่างกันหรือพอ ๆ กันได้
...
คำตอบที่ได้คือ ไม่มีความตายตัว โดย  <br>
หนังสือที่มีราคาถูกกว่าก็สามารถมี Rating สูงกว่า หนังสือที่มีราคาแพงกว่าได้  <br>
และหนังสือที่มีราคาถูกกว่าก็สามารถมี Rating ต่ำกว่า หนังสือที่มีราคาแพงกว่าได้  <br>
แล้วหนังสือที่ราคาพอ ๆ กันก็มี Rating ที่ต่างกันหรือพอ ๆ กันได้  <br>

การกระจายและความหนาแน่นของเส้นกราฟสามารถประเมินความมากน้อยของหนังสือแต่ละประเภทได้  <br>
