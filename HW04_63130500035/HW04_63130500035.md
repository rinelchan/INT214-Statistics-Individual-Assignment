...
`filter()` --> ระบุเงื่อนไขไว้ว่า จำนวนหน้าของหนังสือมีมากกว่าหรือเท่ากับ 1500 <i>Number_Of_Pages</i>   <br>
ได้ใจความว่า หาหนังสือที่มีจำนวนหน้าไม่ต่ำกว่า 1500 หน้า โดยแสดงข้อมูลของชื่อและจำนวนหน้าของหนังสือออกมา
