...
จากกราฟเห็นได้ว่า
variables ที่มีข้อมูลแบบไม่ต่อเนื่อง 43%  และข้อมูลแบบต่อเนื่อง 57%
ทั้งนี้ columns ทั้งหมดที่มีค่าที่หายไปคือ 0%
รวมถึงจำนวน row หรือ ข้อมูลที่สมบูรณ์ 100% และมี missing observation valueที่ขาดหายไปอยู่ 0%
